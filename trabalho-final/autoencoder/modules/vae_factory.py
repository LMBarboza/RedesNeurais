...
class VAEFactory(AbstractRedeFactory):
    def createRede(
        ...
        encoder.add_module("linear_latente1", nn.Linear(sAntes, sLatent))
        encoder.add_module("linear_latente2", nn.Linear(sAntes, sLatent))
